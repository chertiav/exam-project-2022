...
export const SelectInput = ({
	header, classes, optionsArray, valueArray, ...props }) => {

	const { form: { setFieldValue }, meta: { initialValue }, field } = props;
	...
	}, [setFieldValue, field.name, initialValue, optionsArray, valueArray]);
